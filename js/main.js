...
document.addEventListener('DOMContentLoaded', function() {
    console.log('📦 Git Desde Cero - Sitio cargado correctamente');
    ...
    console.log('%c📦 ¡Bienvenido a Git Desde Cero!', 'font-size: 20px; color: #f05032; font-weight: bold;');
    console.log('%cAprende Git de manera fácil y práctica', 'font-size: 14px; color: #6cc644;');
});
